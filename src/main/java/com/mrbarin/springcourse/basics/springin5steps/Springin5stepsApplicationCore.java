...
//A class application to run in spring core and not in spring boot
//@SpringBootApplication
@Configuration
@ComponentScan("com.mrbarin.springcourse.basics.springin5steps")
public class Springin5stepsApplicationCore {

	// Spring IOC container create the instances of the bean including its
	// destruction
	...
	public static void main(String[] args) {
		...
		try (AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(
				Springin5stepsApplicationCore.class)) {

			// By default a bean is a singleton, it will be the same instance every time we
			// ask for it.
